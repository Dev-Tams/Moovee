        ...
        <div class="w-full lg:w-auto ">
            ...
            <div class="w-full lg:w-auto flex-2 ">
                ...
                <nav class="flex flex-col mb-6 text-white ">
                    ...
                    <a class="Footer_footer-link__1x467 text-white no-underline hover:text-gray-400" target="_self" href="/about-us">About us</a>
                    <a class="Footer_footer-link__1x467 text-white no-underline hover:text-gray-400" target="_blank" href="https://blog.giglogistics.com/">Blog</a>
                    <a class="Footer_footer-link__1x467 text-white no-underline hover:text-gray-400" target="_self" href="/terms">Terms and Conditions</a>
            ...
            <div class="w-full lg:w-auto flex-3 ">
                ...
                <nav class="flex flex-col mb-6 ">
                    ...
                    <a class="Footer_footer-link__1x467 text-white no-underline hover:text-gray-400" target="_self" href="/giggo-delivery-app">Schedule a Pickup</a>
                    <a class="Footer_footer-link__1x467 text-white no-underline hover:text-gray-400" target="_blank" href="https://www.shoponalpha.com/">GIG Alpha</a>
                    <a class="Footer_footer-link__1x467 text-white no-underline hover:text-gray-400" target="_self" href="/overseas-shipping">Overseas Shipping</a>
                    <a class="Footer_footer-link__1x467 text-white no-underline hover:text-gray-400" target="_self" href="/report-issues">Report Issues</a>
                </nav>
            </div>
