...
<body>
    ...
    <div class="container bg-[#fff]">
        ...
        <section id="residential-moving" class="flex flex-col justify-end items-start ml-4 bg-contain  h-96 m-7 p-10 text-[#fff]" style="background-image: url('css/images/2255.jpg');" loading="lazy">
            <h2 class="block text-center font-extrabold font-sans">Residential Moving</h2>
            <div>
                <p class="text-lg font-bold font-sans">Moving to a new home can be a daunting task, but with MoveEase, it becomes an effortless transition. Our residential moving services are designed to cater to your every need, ensuring a stress-free experience from start to finish.</p>
            </div>
            <div>
        ...
        <section id="commercial-moving" class="flex flex-col justify-end items-start ml-4 bg-contain h-96 m-7 p-10 text-white" style="background-image: url('css//images/commercial.jpeg');" loading="lazy">
            <h2 class="block text-center font-extrabold font-sans">Commercial Moving</h2>
            <p class="font-bold font-sans text-lg">Relocating your business is a significant endeavor, but with MoveEase, it's a seamless transition that keeps your operations running smoothly. Our commercial moving services are tailored to meet the demands of businesses of all sizes.</p>
        ...
        <section>
            <div class="container">
                ...
                <div class="grid grid-cols-6 gap-4">
                    <div class="border-2 border-solid border-gray-400 p-4 hover:border-black">
